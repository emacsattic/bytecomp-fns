...
;; Copyright (C) 1996, 97, 98, 99, 2007 Noah S. Friedman
...
(defadvice byte-compile-dest-file (around bytecomp-fns:override activate)
  "Override default definition and call `bcf-byte-compile-dest-file' instead."
  (setq ad-return-value (bcf-byte-compile-dest-file (ad-get-arg 0))))
